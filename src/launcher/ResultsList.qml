...
RowLayout {
    ...
    required property int entryHeight
    required property int maxVisibleEntries
    ...
    Layout.preferredHeight: {
        var visible = Math.min(root.maxVisibleEntries, root.count);
